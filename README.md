...
- [ ] Семантика. Возможно...
- [ ] Превью для ссылки 
- [ ] Фото в пикселях в whoami
- [ ] Подумать что сделать со светофором кнопок

- [x] Уменьшить специфичность глобальных стилей
- [x] Переключение языка на телефоне
- [x] Кнопка для скачивания резюме в мобилке и планшете
- [x] Опечатки
- [x] Описание компаний и проектов в опыте работы
- [x] Секция Contact
- [x] Скриншот/GIF для README
- [x] Иконка приложения
- [x] Поправить высоту на мобилке
- [x] Аутентичная загрузка приложения
- [x] Опыт работы — парсинг из `cv/CV.md`
- [x] Help только в десктопе
